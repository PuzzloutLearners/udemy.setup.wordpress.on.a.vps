...
sudo cp /home/$username/$vpsinstallerdir/scripts/vps/8.fail2ban/assets/jail.local jail.local
cd jail.d/
sudo cp /home/$username/$vpsinstallerdir/scripts/vps/8.fail2ban/assets/defaults-debian.conf defaults-debian.conf
